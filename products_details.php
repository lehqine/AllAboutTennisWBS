...
<head>
  ...
  <title>All About Tennis : Products Details</title>
  <!-- Bootstrap -->
...
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 well well-sm text-center">
      <?php if ($readrow['fld_product_image'] == "" ) { ?>
        <center><img src="products/nophoto.jpg" class="img-responsive"></center>
      <?php }
      else { ?>
      <center><img src="products/<?php echo $readrow['fld_product_image']?>" class="img-responsive" width="40%"></center>
      <?php } ?>
    </div>
